...
// Adapted from React Bits Ripple Distortion; see THIRD_PARTY_NOTICES.md.

/* eslint-disable react-hooks/refs -- upstream React Bits keeps live render config in a ref */
...
const RippleDistortion = ({
  ...
  return <div ref={mountRef} className={[styles.root, className].filter(Boolean).join(' ')} data-ripple-distortion style={style} />;
};
